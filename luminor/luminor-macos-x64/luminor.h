#ifndef HALIDE_____luminor_h
#define HALIDE_____luminor_h
#include <stdint.h>
...
int luminor_argv(void **args) HALIDE_FUNCTION_ATTRS;
const struct halide_filter_metadata_t *luminor_metadata() HALIDE_FUNCTION_ATTRS;
...
inline const struct halide_filter_metadata_t* (*HALIDE_GET_STANDARD_METADATA_FUNCTION())() {
    return luminor_metadata;
}
#endif


int luminor_old_buffer_t(struct buffer_t *_input, float _brightness, float _contrast, float _gamma, struct buffer_t *_output) HALIDE_FUNCTION_ATTRS;
