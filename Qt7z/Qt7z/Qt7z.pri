...
#        $$PWD/7zip/CPP/Windows/Registry.cpp \
...
#        $$PWD/p7zip/C/XzCrc64Opt.c \
    ...
    SOURCES += \
        ...
        $$PWD/p7zip/CPP/7zip/Common/UniqBlocks.cpp \
        $$PWD/p7zip/CPP/7zip/Compress/CopyCoder.cpp \
        $$PWD/p7zip/CPP/7zip/UI/Common/ArchiveCommandLine.cpp \
        $$PWD/p7zip/CPP/7zip/UI/Common/ArchiveExtractCallback.cpp \
        $$PWD/p7zip/CPP/7zip/UI/Common/ArchiveOpenCallback.cpp \
        $$PWD/p7zip/CPP/7zip/UI/Common/Bench.cpp \
        $$PWD/p7zip/CPP/7zip/UI/Common/DefaultName.cpp \
        $$PWD/p7zip/CPP/7zip/UI/Common/EnumDirItems.cpp \
        $$PWD/p7zip/CPP/7zip/UI/Common/Extract.cpp \
        $$PWD/p7zip/CPP/7zip/UI/Common/ExtractingFilePath.cpp \
        $$PWD/p7zip/CPP/7zip/UI/Common/HashCalc.cpp \
        $$PWD/p7zip/CPP/7zip/UI/Common/LoadCodecs.cpp \
        $$PWD/p7zip/CPP/7zip/UI/Common/OpenArchive.cpp \
        $$PWD/p7zip/CPP/7zip/UI/Common/PropIDUtils.cpp \
        $$PWD/p7zip/CPP/7zip/UI/Common/SetProperties.cpp \
        $$PWD/p7zip/CPP/7zip/UI/Common/SortUtils.cpp \
        $$PWD/p7zip/CPP/7zip/UI/Common/TempFiles.cpp \
        $$PWD/p7zip/CPP/7zip/UI/Common/Update.cpp \
        $$PWD/p7zip/CPP/7zip/UI/Common/UpdateAction.cpp \
        $$PWD/p7zip/CPP/7zip/UI/Common/UpdateCallback.cpp \
        $$PWD/p7zip/CPP/7zip/UI/Common/UpdatePair.cpp \
        $$PWD/p7zip/CPP/7zip/UI/Common/UpdateProduce.cpp \
        $$PWD/p7zip/CPP/7zip/UI/Console/BenchCon.cpp \
        $$PWD/p7zip/CPP/7zip/UI/Console/ConsoleClose.cpp \
        $$PWD/p7zip/CPP/7zip/UI/Console/ExtractCallbackConsole.cpp \
        $$PWD/p7zip/CPP/7zip/UI/Console/HashCon.cpp \
        $$PWD/p7zip/CPP/7zip/UI/Console/List.cpp \
        $$PWD/p7zip/CPP/7zip/UI/Console/OpenCallbackConsole.cpp \
        $$PWD/p7zip/CPP/7zip/UI/Console/PercentPrinter.cpp \
        $$PWD/p7zip/CPP/7zip/UI/Console/UpdateCallbackConsole.cpp \
        $$PWD/p7zip/CPP/7zip/UI/Console/UserInputUtils.cpp \
        $$PWD/p7zip/CPP/Common/CRC.cpp \
        $$PWD/p7zip/CPP/Common/CommandLineParser.cpp \
        $$PWD/p7zip/CPP/Common/IntToString.cpp \
        $$PWD/p7zip/CPP/Common/ListFileUtils.cpp \
...
#        $$PWD/p7zip/CPP/7zip/UI/Console/Main.cpp \
#        $$PWD/p7zip/CPP/7zip/UI/Console/MainAr.cpp \
